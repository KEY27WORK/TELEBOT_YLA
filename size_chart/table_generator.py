"""
📐 table_generator.py — генератор зображень таблиць розмірів.

🔹 Класи:
- `BaseTableGenerator`: Базовий клас з загальними методами.
- `GeneralTableGenerator`: Генерація загальних таблиць розмірів.
- `UniqueTableGenerator`: Генерація адаптивних таблиць розмірів.
- `UniqueGridTableGenerator`: Генерація таблиць у вигляді сітки (вага/зріст).

📌 Використовує:
- PIL (Pillow) для створення зображень.
- asyncio для асинхронної генерації.
- logging для логування.

✅ Принципи SOLID:
- SRP: Кожен клас має свою чітку відповідальність.
- OCP: Легко додати нові типи таблиць, успадковуючи від базового класу.
"""
...
class BaseTableGenerator:
    """📏 Базовий клас для генерації таблиць розмірів."""
...
class GeneralTableGenerator(BaseTableGenerator):
    """📋 Генератор загальних таблиць розмірів."""
...
class UniqueTableGenerator(BaseTableGenerator):
    """🖌️ Генератор адаптивних таблиць розмірів."""
...
class UniqueGridTableGenerator:
    """🔲 Генератор таблиць розмірів у вигляді сітки (вага/зріст)."""
